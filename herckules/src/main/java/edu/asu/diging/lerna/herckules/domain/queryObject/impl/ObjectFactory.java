...
public class ObjectFactory {
	...
	public final static QName _Target_QNAME = new QName("http://digitalhps.org/lerna-query-model", "target");
	public final static QName _And_QNAME = new QName("http://digitalhps.org/lerna-query-model", "and");
	public final static QName _Or_QNAME = new QName("http://digitalhps.org/lerna-query-model", "or");
	public final static QName _Source_QNAME = new QName("http://digitalhps.org/lerna-query-model", "source");
